...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#4F46E5', paddingTop: 50, paddingBottom: 16, paddingHorizontal: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  timer: { fontSize: 20, fontWeight: 'bold', color: '#fff' },
  examTitle: { fontSize: 16, color: '#c7c5ff' },
  ...
  marks: { fontSize: 14, color: '#4F46E5', fontWeight: 'bold' },
