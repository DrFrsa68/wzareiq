      ...
      <View style={styles.nav}>
        ...
        {isLast ? (
          <TouchableOpacity style={styles.submitBtn} onPress={() => handleSubmit(false)} disabled={submitting}>
            <Text style={styles.submitBtnText}>{submitting ? 'جاري التصحيح...' : 'تسليم الامتحان'}</Text>
...
const styles = StyleSheet.create({
  ...
  questionText: { fontSize: 17, color: '#1A1A2E', textAlign: 'right', lineHeight: 28, marginBottom: 24, backgroundColor: '#fff', borderRadius: 16, padding: 16 },
