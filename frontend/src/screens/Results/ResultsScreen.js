...
const styles = StyleSheet.create({
  ...
  loadingText: { fontSize: 15, color: '#888', textAlign: 'center' },
  ...
  gradingBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6, marginTop: 10 },
  gradingText: { color: '#fff', fontSize: 13, fontWeight: '600' },
  actions: { flexDirection: 'row', gap: 12, margin: 16 },
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#fff', borderRadius: 14, height: 50, borderWidth: 2, borderColor: '#4F46E5', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
